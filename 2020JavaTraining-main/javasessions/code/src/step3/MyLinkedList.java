...
public class MyLinkedList<E> {
    ...
    public <U> U reduceRight(U seed,BiFunction<U,E,U> reducerFunction){
        //(acc,e)->acc
        return reduceLeft(seed,acc->e->reducerFunction.apply(acc,e));
    }
    ...
    public <U> U reduceRight(U seed,Function<? super E,Function<? super U,? extends U>> reducerFunction){
    	U accum = seed;
    	 ...
    	 while (iterate.hasNext()){
             E next = iterate.next();
             accum = reducerFunction.apply(next).apply(accum);
...
//        System.out.println("numbers = " + numbers);
        ...
        sum=numbers.reduceLeft(0, acc -> e -> acc + e);
        
        Integer sumR = numbers.reduceRight(0, e -> acc -> e + acc);
